...
void _insertDialog(BuildContext context) {
 ...
 TextFormField(
  ...
  child:
     ...
     //editing controller of this TextField
          decoration: InputDecoration( 
                    suffixIcon: Icon(Icons.upload_file,color: Colors.grey.shade500,), //icon of text field
                    labelText: 'รูปการตรวจประวัติอาชญากรรม',
          labelStyle: TextStyle(fontSize: 25.0,color: Colors.grey.shade700),
            floatingLabelStyle: TextStyle(fontSize: 25.0,color: Colors.grey.shade700),
            floatingLabelBehavior: FloatingLabelBehavior.always,
    hintText: 'กดเลือกรูป',
 ...
 TextFormField(
   controller: presentjob,
      decoration: InputDecoration(
          labelText: 'อาชีพปัจจุบัน',
          labelStyle: TextStyle(fontSize: 25.0,color: Colors.grey.shade700),
            floatingLabelStyle: TextStyle(fontSize: 25.0,color: Colors.amber),
            floatingLabelBehavior: FloatingLabelBehavior.always,
          hintText: 'กรุณากรอกอาชีพปัจจุบัน',
          hintStyle: TextStyle(fontSize: 17.0,color: Colors.grey.shade500),
   focusedBorder:UnderlineInputBorder(
            borderSide: const BorderSide(color: Colors.amber, width: 2.0),
          ),
 ...
 TextFormField(
   controller: ability,
      decoration: InputDecoration(
          labelText: 'รายละเอียดเพิ่มเติมเกี่ยวกับอาชีพ',
          labelStyle: TextStyle(fontSize: 25.0,color: Colors.grey.shade700),
            floatingLabelStyle: TextStyle(fontSize: 25.0,color: Colors.amber),
            floatingLabelBehavior: FloatingLabelBehavior.always,
          hintText: 'กรุณากรอกรายละเอียดเพิ่มเติมเกี่ยวกับอาชีพ',
          hintStyle: TextStyle(fontSize: 17.0,color: Colors.grey.shade500),
   focusedBorder:UnderlineInputBorder(
            borderSide: const BorderSide(color: Colors.amber, width: 2.0),
          ),
 ...
 TextFormField(
   controller: detail,
      decoration: InputDecoration(
          labelText: 'สิ่งที่สามารถทำเพิ่มเติม',
          labelStyle: TextStyle(fontSize: 25.0,color: Colors.grey.shade700),
            floatingLabelStyle: TextStyle(fontSize: 25.0,color: Colors.amber),
            floatingLabelBehavior: FloatingLabelBehavior.always,
          hintText: 'ตัวอย่างการกรอก ดูแล,กายภาพบำบัด',
          hintStyle: TextStyle(fontSize: 17.0,color: Colors.grey.shade500),
   focusedBorder:UnderlineInputBorder(
            borderSide: const BorderSide(color: Colors.amber, width: 2.0),
          ),
  ...
  padding: const EdgeInsets.only(
      ...
      child: TextFormField(
       //editing controller of this TextField
          decoration: InputDecoration( 
                    suffixIcon: Icon(Icons.upload_file,color: Colors.grey.shade500,), //icon of text field
                    labelText: 'Resume เพื่อยืนยันข้อมูลเบื้องต้น',
          labelStyle: TextStyle(fontSize: 25.0,color: Colors.grey.shade700),
            floatingLabelStyle: TextStyle(fontSize: 25.0,color: Colors.grey.shade700),
            floatingLabelBehavior: FloatingLabelBehavior.always,
    hintText: 'กดเลือกรูป',
 ...
 TextFormField(
  controller: rate,
      decoration: InputDecoration(
          labelText: 'อัตราค่าบริการ (รายชั่วโมง)',
          labelStyle: TextStyle(fontSize: 25.0,color: Colors.grey.shade700),
            floatingLabelStyle: TextStyle(fontSize: 25.0,color: Colors.amber),
            floatingLabelBehavior: FloatingLabelBehavior.always,
